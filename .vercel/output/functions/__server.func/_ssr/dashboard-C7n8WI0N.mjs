...
function TaxaFilterBar() {
  ...
  const taxaButtons = [
    ...
    { key: "arthropods", label: "פרוקי רגליים", activeColor: "bg-red-300 text-red-900 border-red-500 border-2 font-semibold", inactiveColor: "bg-gray-50 text-gray-500 border-gray-300 font-normal hover:bg-gray-100" },
    { key: "plants", label: "צמחים", activeColor: "bg-lime-300 text-lime-900 border-lime-500 border-2 font-semibold", inactiveColor: "bg-gray-50 text-gray-500 border-gray-300 font-normal hover:bg-gray-100" },
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-nowrap items-center gap-2 overflow-x-auto scrollbar-hide", children: taxaButtons.map(({ key, label, activeColor, inactiveColor }) => /* @__PURE__ */ jsxRuntimeExports.jsx(
    "button",
    {
      type: "button",
      onClick: () => toggleTaxa(key),
      className: `shrink-0 inline-flex items-center whitespace-nowrap rounded-full border px-2.5 py-1 text-sm font-medium transition-all duration-200 ${filters.taxa.has(key) ? activeColor : inactiveColor}`,
...
function MetricsTable({ data }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "overflow-hidden rounded border bg-card h-full flex flex-col", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1 min-h-0", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("table", { className: "w-full h-full text-xs", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("tbody", { children: rows.map((r) => /* @__PURE__ */ jsxRuntimeExports.jsxs("tr", { className: "border-b border-gray-100 hover:bg-secondary/30", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("td", { className: "px-2 py-1 text-center tabular-nums text-xs", children: r.rawGroup === "expert" ? /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-muted-foreground", children: "-" }) : /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "rounded bg-emerald-soft px-1.5 py-0.5 text-[color:var(--accent-foreground)] text-[10px]", children: [
...
const GROUP_CONFIG = [
  { key: PROFESSIONAL_MONITORING_KEY, color: "#6366F1", shape: "diamond" },
  { key: "local_communities", color: "#000000", shape: "circle" },
  { key: "student", color: "#4A4A4A", shape: "cross" },
  { key: "online_communities", color: "#B0B0B0", shape: "triangle" }
];
...
const DOT_RENDERERS = [CircleDot, CrossDot, TriangleDot, DiamondDot];
...
function TimeSeriesChart({ data }) {
  ...
  const { rawCounts, allSortKeys, allGroups } = reactExports.useMemo(() => {
    ...
    allGroups2.add(PROFESSIONAL_MONITORING_KEY);
...
function Dashboard() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { className: "flex h-full w-full flex-col overflow-hidden", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "shrink-0 grid grid-cols-[1fr_auto_1fr] items-center min-h-[3.5rem] w-full px-4 py-0.5", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex justify-center max-w-full overflow-x-auto scrollbar-hide", children: /* @__PURE__ */ jsxRuntimeExports.jsx(TaxaFilterBar, {}) }),
